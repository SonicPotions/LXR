...
//	int i;
	...
	//parameterArray[PAR_DUMMY_DIST4].ptr 			= &snareVoice.;
	//parameterArray[PAR_DUMMY_DIST4].type 			= TYPE_UINT8;		//noch entfernen!	//50
...
/*
	parameterArray[PAR_EQ1_GAIN].ptr 				= ;
	parameterArray[PAR_EQ1_GAIN].type 				= TYPE_UINT8;

	parameterArray[PAR_EQ1_F].ptr 	= ;
	parameterArray[PAR_EQ1_F].type = TYPE_UINT8;

	parameterArray[PAR_EQ2_GAIN].ptr 	= ;
	parameterArray[PAR_EQ2_GAIN].type = TYPE_UINT8;

	parameterArray[PAR_EQ2_F].ptr 	= ;
	parameterArray[PAR_EQ2_F].type = TYPE_UINT8;

	parameterArray[PAR_EQ3_GAIN].ptr 	= ;
	parameterArray[PAR_EQ3_GAIN].type = TYPE_UINT8;

	parameterArray[PAR_EQ3_F].ptr 	= ;
	parameterArray[PAR_EQ3_F].type = TYPE_UINT8;

	parameterArray[PAR_EQ4_GAIN].ptr 	= ;
	parameterArray[PAR_EQ4_GAIN].type = TYPE_UINT8;

	parameterArray[PAR_EQ4_F].ptr 	= ;
	parameterArray[PAR_EQ4_F].type = TYPE_UINT8;

	parameterArray[PAR_EQ5_GAIN].ptr 	= ;
	parameterArray[PAR_EQ5_GAIN].type = TYPE_UINT8;

	parameterArray[PAR_EQ5_F].ptr 	= ;
	parameterArray[PAR_EQ5_F].type = TYPE_UINT8;

	parameterArray[PAR_EQ6_GAIN].ptr 	= ;
	parameterArray[PAR_EQ6_GAIN].type = TYPE_UINT8;

	parameterArray[PAR_EQ6_F].ptr 	= ;
	parameterArray[PAR_EQ6_F].type = TYPE_UINT8;
	*/
	...
	parameterArray[PAR_FILTER_TYPE_4].ptr 				= &cymbalVoice.filterType;
	parameterArray[PAR_FILTER_TYPE_4].type 				= TYPE_UINT8;

	parameterArray[PAR_FILTER_TYPE_5].ptr 				= &hatVoice.filterType;;
	...
	parameterArray[PAR_FILTER_DRIVE_2].ptr 				= &voiceArray[0].filter.drive;
	parameterArray[PAR_FILTER_DRIVE_2].type 			= TYPE_FLT;

	parameterArray[PAR_FILTER_DRIVE_3].ptr 				= &voiceArray[0].filter.drive;
...
/*
	...
	parameterArray[PAR_BEGINNING_OF_GLOBALS].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;	//a placeholder to mark the beginning of the global var space not present in morph and not needed in the seq

	//END OF MIDI DATASIZE
	//parameterArray[PARAM NR 127 REACHED

	//LFOs
	parameterArray[PAR_FREQ_LFO1 = parameterArray[PAR_BEGINNING_OF_GLOBALS].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_FREQ_LFO2].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_FREQ_LFO3].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_FREQ_LFO4].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_FREQ_LFO5].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_FREQ_LFO6].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_WAVE_LFO1].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_WAVE_LFO2].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_WAVE_LFO3].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_WAVE_LFO4].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_WAVE_LFO5].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_WAVE_LFO6].ptr 	= ;parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	//the target and voice parameterArray[PARameters must be after one another!
	parameterArray[PAR_VOICE_LFO1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	...
	parameterArray[PAR_AMOUNT_LFO1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AMOUNT_LFO2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AMOUNT_LFO3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AMOUNT_LFO4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AMOUNT_LFO5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AMOUNT_LFO6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_RETRIGGER_LFO1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_RETRIGGER_LFO2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_RETRIGGER_LFO3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_RETRIGGER_LFO4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_RETRIGGER_LFO5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_RETRIGGER_LFO6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_SYNC_LFO1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_SYNC_LFO2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_SYNC_LFO3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_SYNC_LFO4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_SYNC_LFO5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_SYNC_LFO6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;



	parameterArray[PAR_OFFSET_LFO1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_OFFSET_LFO2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_OFFSET_LFO3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_OFFSET_LFO4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_OFFSET_LFO5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_OFFSET_LFO6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_ROLL].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_MORPH].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	//placeholder parameterArray[PARameters for the step parameterArray[PARam display
	//TODO don't have to go into preset
	parameterArray[PAR_ACTIVE_STEP].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_STEP_VOLUME].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_STEP_PROB].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_STEP_NOTE].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_EUKLID_LENGTH].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_EUKLID_STEPS].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	//global parameterArray[PARams
	parameterArray[PAR_BPM].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;



	parameterArray[PAR_MIDI_CHAN_1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_MIDI_CHAN_2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_MIDI_CHAN_3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_MIDI_CHAN_4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_MIDI_CHAN_5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_MIDI_CHAN_6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_AUDIO_OUT1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AUDIO_OUT2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AUDIO_OUT3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AUDIO_OUT4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AUDIO_OUT5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_AUDIO_OUT6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_VOICE_DECIMATION1].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_VOICE_DECIMATION2].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_VOICE_DECIMATION3].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_VOICE_DECIMATION4].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_VOICE_DECIMATION5].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_VOICE_DECIMATION6].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_VOICE_DECIMATION_ALL].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;

	parameterArray[PAR_PATTERN_BEAT].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
	parameterArray[PAR_PATTERN_NEXT].ptr 	= ;
	parameterArray[PAR_OSC_WAVE_DRUM3].type = TYPE_UINT8;
