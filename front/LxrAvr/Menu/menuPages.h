...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	*/
	...
	{
		{
			TEXT_PAT_LENGTH,	TEXT_NUM_STEPS,		TEXT_ROTATION,			TEXT_NOTE_RANDOM,				TEXT_ROLL_SPEED,	TEXT_X_FADE,	TEXT_EMPTY,TEXT_EMPTY,
			PAR_EUKLID_LENGTH,	PAR_EUKLID_STEPS,	PAR_EUKLID_ROTATION,	PAR_EUKLID_NOTE_RANDOM,		PAR_ROLL, 			PAR_MORPH,	PAR_NONE,PAR_NONE
		}		
	},
