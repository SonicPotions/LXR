...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	// MENU_MIDI_PAGE - hold shift and load/save. do it again to access 5-8, and again to access others
	{
		...
		{ // -- AS GMENU Some are Dummy values now to test!
			TEXT_SCREENSAVER_ON_OFF, TEXT_BAR_RESET_MODE,    /*dummy here on*/TEXT_MOD_LFO,		TEXT_WAVE_LFO,	TEXT_RETRIGGER_LFO,	TEXT_OFFSET_LFO,	TEXT_TARGET_VOICE_LFO,	TEXT_TARGET_LFO,
			PAR_SCREENSAVER_ON_OFF,  PAR_BAR_RESET_MODE,     /*dummy here on*/PAR_AMOUNT_LFO6,	PAR_WAVE_LFO6,	PAR_RETRIGGER_LFO6,	PAR_OFFSET_LFO6,	PAR_VOICE_LFO6,			PAR_TARGET_LFO6
