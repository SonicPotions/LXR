...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	{
		{
			TEXT_BPM, /*TEXT_MIDI_MODE,*/ TEXT_FETCH, TEXT_FOLLOW, TEXT_QUANTISATION, TEXT_SCREENSAVER_ON_OFF, TEXT_EMPTY, TEXT_EMPTY, TEXT_EMPTY,
			PAR_BPM,  /*PAR_MIDI_MODE,*/  PAR_FETCH,  PAR_FOLLOW,  PAR_QUANTISATION,  PAR_SCREENSAVER_ON_OFF,  PAR_NONE,   PAR_NONE, PAR_NONE
		},
		{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
