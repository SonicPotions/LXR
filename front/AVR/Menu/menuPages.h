...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	// MENU_MIDI_PAGE - hold shift and load/save. do it again to access 5-8
	{
		...
		{
			TEXT_TRIGGER_IN_PPQ,	TEXT_TRIGGER_OUT1_PPQ,		TEXT_TRIGGER_OUT2_PPQ,		TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_PRESCALER_CLOCK_IN, PAR_PRESCALER_CLOCK_OUT1, 	PAR_PRESCALER_CLOCK_OUT2,	PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
