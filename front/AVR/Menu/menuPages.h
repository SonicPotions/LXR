...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	// MENU_MIDI_PAGE - hold shift and load/save. do it again to access 5-8
	{
		{
			TEXT_BPM, /*TEXT_MIDI_MODE,*/ TEXT_FETCH, TEXT_FOLLOW, TEXT_QUANTISATION, TEXT_SCREENSAVER_ON_OFF, TEXT_MIDI_ROUTING, TEXT_MIDI_FILT_TX, TEXT_MIDI_FILT_RX,
			PAR_BPM,  /*PAR_MIDI_MODE,*/  PAR_FETCH,  PAR_FOLLOW,  PAR_QUANTISATION,  PAR_SCREENSAVER_ON_OFF,  PAR_MIDI_ROUTING, PAR_MIDI_FILT_TX, PAR_MIDI_FILT_RX
		},
		{ // -- AS GMENU Dummy values now to test!
			TEXT_BAR_RESET_MODE,TEXT_SYNC_LFO,	TEXT_MOD_LFO,		TEXT_WAVE_LFO,	TEXT_RETRIGGER_LFO,	TEXT_OFFSET_LFO,	TEXT_TARGET_VOICE_LFO,	TEXT_TARGET_LFO,
			PAR_BAR_RESET_MODE,	PAR_SYNC_LFO6,	PAR_AMOUNT_LFO6,	PAR_WAVE_LFO6,	PAR_RETRIGGER_LFO6,	PAR_OFFSET_LFO6,	PAR_VOICE_LFO6,			PAR_TARGET_LFO6
		},{ // --AS GMENU Dummy values here too!
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_COARSE6,	PAR_FINE6,	PAR_WAVE1_HH,	PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
