...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		...
		//page 8 - MIX
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE, TEXT_AUDIO_OUT,	TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_VOICE_MIDI_NOTE,
			PAR_VOL1,		PAR_PAN1,	PAR_VOICE_DECIMATION1,	PAR_DRIVE1,	PAR_AUDIO_OUT1,	PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_1,	PAR_VOICE_MIDI_NOTE
		}
	},
	//page 2 - Voice 2 - drum
	{
		...
		//page 8 - MIX
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE, TEXT_AUDIO_OUT,	TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_EMPTY,	//TEXT_MIDI_CHANNEL,	TEXT_AUDIO_OUT,			
			PAR_VOL2,		PAR_PAN2,	PAR_VOICE_DECIMATION2,	PAR_DRIVE2,	PAR_AUDIO_OUT2,	PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_2,	PAR_NONE				//PAR_MIDI_CHAN_1,	PAR_AUDIO_OUT1,				
		}
	},
	//page 3 - Voice 3 - drum
	{
		...
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE, TEXT_AUDIO_OUT,	TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_EMPTY,	//TEXT_MIDI_CHANNEL,	TEXT_AUDIO_OUT,			
			PAR_VOL3,		PAR_PAN3,	PAR_VOICE_DECIMATION3,	PAR_DRIVE3,	PAR_AUDIO_OUT3,	PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_3,	PAR_NONE				//PAR_MIDI_CHAN_1,	PAR_AUDIO_OUT1,				
		}
	},
	//page 4 - Voice 4 - snare/clap
	{
		...
		//MIX
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE,				TEXT_AUDIO_OUT,	TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_EMPTY,
			PAR_VOL4,		PAR_PAN4,	PAR_VOICE_DECIMATION4,	PAR_SNARE_DISTORTION,	PAR_AUDIO_OUT4,	PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_4,	PAR_NONE
		}
	},
	//page 5 - Voice 5 - cymbal
	{
		...
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE,					TEXT_AUDIO_OUT,		TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_EMPTY,
			PAR_VOL5,		PAR_PAN5,	PAR_VOICE_DECIMATION5,	PAR_CYMBAL_DISTORTION,		PAR_AUDIO_OUT5,		PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_5,	PAR_NONE
		}
	...
	//page 6 - Voice 6 - HH/Cymbal (FM)
	{
		...
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE,			TEXT_AUDIO_OUT,	TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_EMPTY,
			PAR_VOL6,		PAR_PAN6,	PAR_VOICE_DECIMATION6,	PAR_HAT_DISTORTION,	PAR_AUDIO_OUT6,	PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_6,	PAR_NONE
		}
	},
	//page 7 - Voice 6 - HH/Cymbal (FM) - same as voice 6 -> open hi hat
	{
		...
		{
			TEXT_VOLUME,	TEXT_PAN,	TEXT_SAMPLE_RATE,		TEXT_DRIVE,			TEXT_AUDIO_OUT,	TEXT_PAT_LENGTH,	TEXT_MIDI_CHANNEL,	TEXT_EMPTY,
			PAR_VOL6,		PAR_PAN6,	PAR_VOICE_DECIMATION6,	PAR_HAT_DISTORTION,	PAR_AUDIO_OUT6,	PAR_TRACK_LENGTH,	PAR_MIDI_CHAN_7,	PAR_NONE
		}
	},
	...
	{
		{
			TEXT_BPM,	TEXT_MIDI_MODE,	TEXT_FETCH,	TEXT_FOLLOW,	TEXT_QUANTISATION,	TEXT_SCREENSAVER_ON_OFF,	TEXT_EMPTY,	TEXT_EMPTY,
			PAR_BPM,	PAR_MIDI_MODE,	PAR_FETCH,	PAR_FOLLOW,		PAR_QUANTISATION,	PAR_SCREENSAVER_ON_OFF,		PAR_NONE, PAR_NONE
		},
		{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
