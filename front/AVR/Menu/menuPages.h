...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	{
		{
			TEXT_BPM,	TEXT_MIDI_CHANNEL,	TEXT_FETCH,	TEXT_FOLLOW,	TEXT_QUANTISATION,	TEXT_SCREENSAVER_ON_OFF,	TEXT_EMPTY,	TEXT_EMPTY,	
			PAR_BPM,	PAR_MIDI_CHAN_1,	PAR_FETCH,	PAR_FOLLOW,		PAR_QUANTISATION,	PAR_SCREENSAVER_ON_OFF,		PAR_NONE,	PAR_NONE
		}		
	},
		//page 8 - Load
	{
	...
	*/
	{
		{		
			TEXT_STEP_VOLUME,	TEXT_NOTE,		TEXT_PROBABILITY,	TEXT_SKIP,	TEXT_PARAM_DEST,	TEXT_PARAM_VAL,	TEXT_PARAM_DEST,	TEXT_PARAM_VAL,		
