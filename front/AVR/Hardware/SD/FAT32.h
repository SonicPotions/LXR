...
unsigned long fat_getSetNextCluster (unsigned long clusterNumber,unsigned char get_set,unsigned long clusterEntry);
...
//callback functions to handle data from FAT - needs to be implemented by the user
void fat_processData(unsigned char data);
